...
2. **Four columns built and verified across two legislatures.** The tracker's **"By Legislator"** view (in `html`, generated by `build_voting_record.py` from the official roll calls in [`sources/rollcalls/`](./sources/rollcalls/)) now covers **c.388, c.650 (132nd)** and **c.412, c.643 (131st)** — a 236-legislator union roster. Every parse reconciles exactly to the printed tallies. A **legislature grouping/filter** lets constituents view one Legislature at a time (columns + only the members seated then), so cross-session roster turnover reads as "different Legislature," not "didn't vote." Districts come from the rosters in [`sources/rosters/`](./sources/rosters/): current-legislature Senate 35/35 and House 151/152 (only Harriman of Lewiston, a special-election winner not yet on the district roster, is left blank — never guessed; earlier-legislature-only members carry no current district by design). The remaining older bills (rows 8, 18, 19) stay "TBD" until their roll calls are supplied. Row 17 is resolved as **attribution-risk**: HP 891 / LD 1216 (PL 2021, c. 181) passed with no recorded roll call, under the hammer, so no member-level vote exists to attribute.
...
| 3 | Canned software taxable | LD 2214 · PL 2023 c.643 | 131st (2024) | House **RC #549 75–63**, Senate **RC #794 19–14** · enacted **Apr 17 2024** | confirmed |
...
| 7 | Lease-stream taxation timing | LD 2214 · PL 2023 c.643 | 131st (2024) | *(same vote as #3)* | confirmed |
...
| 10 | PFML: new 1% payroll tax | LD 258 · PL 2023 c.412 | 131st (2023) | House **RC #350 80–58**, Senate **RC #478 22–9** · passage **Jul 6 2023** | confirmed |
...
| 17 | Corporate nexus standards | HP 891 / LD 1216 · PL 2021 c.181 | 130th (2021) | No roll call — passed under the hammer, signed Jun 11 2021 | attribution-risk |
...
| 20 | Hospital SPT rate +46% | LD 2214 · PL 2023 c.643 | 131st (2024) | *(same vote as #3)* | confirmed |
...
| 22 | PTDZ/ETIF/MCIC programs sunset | LD 258 · PL 2023 c.412 | 131st (2023) | *(same vote as #10)* | confirmed |
| 23 | Pension exemption phase-out | LD 210 · PL 2025 c.388 | 132nd (2025) | *(same vote as #1)* | reported |
| 24 | Senior property-tax freeze repealed | LD 258 · PL 2023 c.412 | 131st (2023) | *(same vote as #10)* | confirmed |
